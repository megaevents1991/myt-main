...
export const ReferFriend = ({
  ...
  return (
    <Card className="flex flex-col w-full items-start gap-4 p-3 rounded-2xl shadow-[0px_0px_12px_#0000001a] [background:linear-gradient(180deg,#0FA049_0%,hsl(var(--brand-forest))_100%)]">
      <CardContent className="flex flex-col items-center gap-4 w-full p-0">
        ...
        >
          <span className="font-bold text-forest text-base leading-normal [font-family:'IBM_Plex_Sans_Hebrew',Helvetica] tracking-[0] [direction:rtl]">
            {"העתיקו את הקישור"}
          </span>
        </Button>
      </CardContent>
            ...
            >
              ...
              <div className="inline-flex flex-col items-center justify-center gap-1">
                <div className="flex w-6 h-6 items-center justify-center bg-white rounded-[20px]">
                  <div className="font-buttons-mobile-btn2 font-semibold text-forest text-xs text-center">
                    {index + 1}
                  </div>
                </div>
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-md" dir="rtl">
          <DialogHeader>
            <DialogTitle className="text-center text-forest font-bold">
              שתף עם חברים
            </DialogTitle>
          </DialogHeader>
          <div className="flex flex-col gap-4">
            ...
            <div className="flex justify-center gap-8 pt-2">
              ...
              >
                <FiCopy size={36} className="text-forest" />
              ...
              <Button
                ...
                onClick={handleShare}
              >
                <FiShare2 size={36} className="text-forest" />
            ...
            {showCopyNotification && (
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-forest text-white px-4 py-2 rounded-md flex items-center gap-2 shadow-md transition-opacity duration-300">
