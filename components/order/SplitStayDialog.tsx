 ...
 * the flight step's job) - the popup only assigns nights to cities.
 */
    ...
    >
      <div className="flex flex-col gap-4" dir="rtl">
        <p className="text-[13px] text-muted-foreground">
          {`בחרנו בשבילכם ${wantNights} לילות ב${eventCity} סביב המשחק, השאר ב${flightCity}. לחיצה על לילה מחליפה לו עיר. לשינוי תאריכים חוזרים לשלב הטיסה.`}
        </p>
