...
// Archived version of /cancellation - the terms in force for orders placed
// up to 7.9.26. Frozen: do not edit the text below. Current terms live in
// app/cancellation/terms-content.ts.

export const dynamic = "force-static";
export const revalidate = 3600;

export const metadata: Metadata = {
  title: "תנאים ומידע כללי (נוסח קודם, עד 7.9.26) - מגה איבנטס",
  robots: { index: false, follow: true },
};

export default function ArchivedCancelPage() {
  return (
    <main className="container mx-auto p-6" dir="rtl">
      <header className="mb-6">
        <h1 className="text-3xl font-bold mb-6 text-center">תנאים ומידע כללי</h1>
        <p className="text-center text-lg font-semibold">נוסח קודם - בתוקף להזמנות שבוצעו עד 7.9.26</p>
      </header>
      <aside
        role="note"
      ...
      >
        <p>
          <strong>זהו נוסח ארכיוני של התנאים.</strong> הוא חל על הזמנות שבוצעו עד
          לתאריך 7.9.26. הזמנות חדשות כפופות{" "}
          <Link href="/cancellation" className="font-semibold text-blue-700 underline dark:text-sky-300">
            לתנאים העדכניים
          </Link>
          .
        </p>
