        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4 items-start">
            <div className="space-y-4 order-1 md:order-2">
              ...
              >
                <div className="w-full rounded-md bg-secondary/10  border-secondary/40 text-success text-center py-2.5 px-3 text-[15px] font-semibold leading-snug tracking-wide shadow-sm">
              ...
              >
                <div className="flex items-center justify-center space-x-2">
                  ...
                  <div className="flex items-center">
                    <Label htmlFor="terms" className="text-base mr-2">
                      אני מאשר/ת שקראתי את
                    </Label>
                    <Dialog>
                      <DialogTrigger asChild>
                        <button
                          className="text-base mr-1 font-semibold text-foreground underline underline-offset-2 hover:text-primary"
                          name="terms"
                          type="button"
