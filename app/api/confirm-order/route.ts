...
export async function POST(req: Request) {
  ...
  try {
    await transporter.sendMail({
      from: '"MegaEvents Reservations" <noreply@mega-events.co.il>',
                      ...
                      <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; border-collapse: collapse; direction: rtl;" dir="rtl">
                          ...
                          <tr>
                              <td style="padding: 20px 20px; text-align: right; direction: rtl;" dir="rtl">
                                  ...
                                  <div style="margin-bottom: 30px; text-align: center; direction: rtl;" dir="rtl">
                                      <h1 style="color: #05203c; font-size: 24px; margin: 0 0 10px 0; direction: rtl;" dir="rtl">תודה שבחרת מגה איבנטס!</h1>
                                      <p style="color: #666666; font-size: 16px; margin: 0; direction: rtl;" dir="rtl">הזמנתך נקלטה,<br>נציגנו ייצור עימך קשר ביום העסקים הקרוב.</p>
                                  </div>
                                  ...
                                  <div style="background-color: #f8f9fa; border-radius: 8px; padding: 20px; margin-bottom: 30px; direction: rtl;" dir="rtl">
                                      ...
                                      <table role="presentation" style="width: 100%; border-collapse: collapse; direction: rtl;" dir="rtl">
                                          ...
                                          <tr>
                                              <td style="padding: 8px 0; color: #666666; text-align: right; direction: rtl;" dir="rtl">
                                                  <strong style="color: #05203c;">מחיר:</strong> <span style="unicode-bidi: embed;">$${replacements.price}</span>
                                              </td>
                                          </tr>
                                      </table>
                                  </div>
                                  ...
                                  <div style="background: linear-gradient(180deg, rgba(0,172,194,1) 31%, rgba(39,126,137,1) 100%); border-radius: 16px; padding: 20px; margin-bottom: 30px; text-align: center; direction: rtl;" dir="rtl">
                                      ...
                                      <div style="color: #ffffff; margin-bottom: 15px; direction: rtl;" dir="rtl">
                                          ...
                                          <p style="font-size: 16px; margin: 0; direction: rtl;" dir="rtl">הזמינו חברים לרכוש באמצעות הלינק שלכם, <strong>ותקבלו <span style="unicode-bidi: embed;">$40</span> החזר (לכל נוסע!)</strong>, וגם הם יקבלו צ'ופר!</p>
                                      </div>
                                      ...
                                      <div style="background-color: #ffffff; border: 2px dashed rgba(255,255,255,0.6); border-radius: 12px; margin-bottom 15px; text-align: center; box-shadow: 0 2px 8px rgba(0,0,0,0.1);" dir="ltr">
                                          <p style="color: #277e89; font-size: 14px; margin: 5px 0 5px 0;">הקישור האישי שלך:</p>
                                          ...
                                          <div style="background: linear-gradient(90deg, rgba(255,255,255,0.9) 0%, rgba(255,255,255,1) 100%); border-radius: 8px; padding: 12px; display: block; position: relative;">
                                              <p style="margin: 0; font-size: 16px; color: #277e89; font-weight: bold; word-break: break-all; direction: ltr; font-family: monospace, Arial, sans-serif; letter-spacing: 0.5px;">https://mega-events.co.il/?aff=${replacements.promoCode}</p>
                                          </div>
                                      </div>                                      
                                      ...
                                      <div style="direction: rtl;" dir="rtl">
                                          <p style="font-size: 13px; color: #ffffff; margin: 0; opacity: 0.9; direction: rtl;" dir="rtl"><span style="unicode-bidi: embed;">$40</span> החזר למשלם ההזמנה, על כל נוסע בהזמנה שתשולם! ועוד <span style="unicode-bidi: embed;">$20</span> הנחה לכל נוסע שישלים הזמנה. הקישור תקף ל-28 יום, ניתן לקבל החזר של עד <span style="unicode-bidi: embed;">$800</span>.</p>
                                      </div>
                                  </div>
                          ...
                          <tr>
                              <td style="background-color: #05203c; padding: 20px; text-align: center; color: #ffffff; direction: rtl;" dir="rtl">
                                  <p style="margin: 0; font-size: 12px; direction: rtl;" dir="rtl">© 2025 מגה איבנטס. כל הזכויות שמורות.</p>
                              </td>
                          </tr>
                      </table>
                  </td>
