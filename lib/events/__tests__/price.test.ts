...
function createMockEvent(overrides: Partial<Event> = {}): Event {
  return {
    ...
    tickets_and_rates: [createTicket(100, true), createTicket(200, true)],
    location: {
      name: "Test City",
      city_iata: "TST",
      latitude: 0,
...
const event3 = createMockEvent({
  tickets_and_rates: [createTicket(100, false), createTicket(200, false)],
});
...
console.log(
  `✓ Is sold out: ${isEventSoldOut(event5)} (tag takes precedence)\n`,
);
...
console.log(
  `✓ Price with custom markup: $${price7} (Expected: $1150 = 500+300+100+250)\n`,
);
...
console.log(
  `✓ Price with event additional markup: $${price8} (Expected: $1155 = 500+300+100+175+80)\n`,
);
